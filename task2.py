...
aggregated_text = read_csv("Results/harry_potter_all_character_full_sentence.csv", sep=",", lineterminator='\n')
...
with open('Results/harry_potter_all_aggregated_personality.csv', 'w', encoding='UTF8', newline='') as f:
    writer = csv.writer(f)
